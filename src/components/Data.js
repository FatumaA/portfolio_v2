...
export const CodeProjectsInfo = [
    {
      ...
      projDesc: 'My portfolio version 1 built with create-react-app and hosted on the Netlify platform',
    ...
    },
    {
      ...
      projDesc: 'It takes in user input, sends a request to the api and translates the response in form of possible diagnosis to the screen',
      projTextLink: 'View Source Code',
