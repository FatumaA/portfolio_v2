    ...
    return (
        <div id="about" className='top-styles'>
            ...
            <p className="text-center leading-7 mt-4">
                ...
                <p className="text-center leading-7 mt-1"> You can also find me at: </p>
                <span className='flex flex-row justify-center mt-1'> 
                    <a href='https://twitter.com/XquisiteDreamer' target='_blank' rel='noreferrer'>
                        <AiFillTwitterSquare/>
                    </a> 
                    <a href='https://www.linkedin.com/in/fatuma-abdullahi-6b804948/' target='_blank' rel='noreferrer'>
                        <AiFillLinkedin/>
                    </a> 
                </span>
